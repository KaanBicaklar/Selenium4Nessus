...
login=browser.find_element(by=By.XPATH, value='/html/body/div/form/button')
login.click()

#if a renew warning pops up, turn it on
#time.sleep(5)
...
upload_file=browser.find_element(by=By.XPATH, value='//*[@id="editor-tab-view"]/div/div[1]/section/div[1]/div[1]/div[1]/div[6]/div/input')

upload_file.send_keys(filename)
